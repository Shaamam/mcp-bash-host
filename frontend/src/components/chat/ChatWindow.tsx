...
export const ChatWindow: React.FC = () => {
    const [messages, setMessages] = useState<Message[]>([
        { text: "Welcome to Blue Agent! How can I help you today?", sender: "bot" },
    ]);
        ...
        <div className="flex flex-col h-[calc(100vh-160px)] max-w-4xl mx-auto px-4 py-6">
            ...
            <div className="bg-[#00095B] rounded-t-lg p-4 text-white">
                <div className="flex items-center">
                    ...
                    {/*</div>*/}
                    <div>
                        <h2 className="text-xl font-medium">Blue Agent</h2>
                        <p className="text-sm font-light">Model Context Protocol Host</p>
                    </div>
            ...
            />
                ...
                <div className="mt-2 text-xs text-gray-500 font-light text-center">
                    Blue Agent can assist LLM to connect with MCP Servers
                </div>
            </form>
        </div>
    );
